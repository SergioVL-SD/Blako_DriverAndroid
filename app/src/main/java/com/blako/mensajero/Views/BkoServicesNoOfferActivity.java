...
import com.blako.mensajero.Adapters.BkoServicesNoOfferAdapter;
...
public class BkoServicesNoOfferActivity extends BaseActivity implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener {

    Toolbar toolbar;
    private TextView startDateTv, todayDateTv, endDateTv, orderTv, workerNameTv;
    String startDate, endDate;
    private BkoServicesNoOfferAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bko_services_no_offer_activity);
        ...
        if (toolbar != null) {
            ...
            mTitle.setText(getString(R.string.blako_servicios_sin_offer));
    ...
    void startCalendar() {
        ...
        DatePickerDialog dpd = DatePickerDialog.newInstance(
                BkoServicesNoOfferActivity.this,
        ...
        showWaitDialogWhileExecuting("Cargando...", new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    BkoUser user = BkoUserDao.Consultar(BkoServicesNoOfferActivity.this);
                    ...
                    mapVisible.put("datefinish", endDate);
                            ...
                            balanceResponse = HttpRequest.get(Constants.GET_SERVICES_NOT_OFFER(BkoServicesNoOfferActivity.this), mapVisible, true).connectTimeout(5000).readTimeout(5000).body();
            ...
            public void run() {
                ...
                try {
                    ...
                    if (balanceResponse != null) {
                        ...
                        Gson gson = new Gson();
                        BkoServiceNoOfferResponse response = gson.fromJson(balanceResponse, BkoServiceNoOfferResponse.class);
                        if (response.isResponse()) {
                            ...
                            adapter = new BkoServicesNoOfferAdapter(response.getServicios());
                        ...
                        Toast.makeText(BkoServicesNoOfferActivity.this, getString(R.string.blako_error), Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    Toast.makeText(BkoServicesNoOfferActivity.this, getString(R.string.blako_error), Toast.LENGTH_SHORT).show();
                }
    ...
    protected void onResume() {
        super.onResume();
        Log.d("GeneralFlux","Activity: "+BkoServicesNoOfferActivity.this.getLocalClassName());
    }
}
